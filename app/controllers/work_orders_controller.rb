class WorkOrdersController < ApplicationController
  ...
  private
    ...
    def work_order_params
      params.require(:work_order).permit(:wo_number, :start_date, :comp_date, :requestor, :priority, :repair_facility, :repair_type, :location, :summary, :est_completion, :percent_complete, :user_id)
    end
end
